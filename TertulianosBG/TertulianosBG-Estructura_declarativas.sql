...
/**materiales
las cantidades no pueden ser nulas, el codigo es VARCHAR2 y el proveedor no puede ser nulo**/

INSERT INTO materiales(codigo, nombre, cantidad, precio)
VALUES(1, 'pruebanoOk', -2000, 0);
